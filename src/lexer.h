...
private:
    ...
    Token GetNumberToken(char peek);
...
private:
    ...
    static std::map<std::string, Token> const keywords_tokens_;

    size_t current_indent_lvl_ = 0u;
    static size_t const indent_space_count_ = 2u;
